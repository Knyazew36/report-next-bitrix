							...
							<div className="sm:hidden ms-1">
								...
								<div className="hs-dropdown  relative  [--auto-close:inside] inline-flex">
									...
									>
										...
										{/* End Tab */}
										{/* Tab Content */}
										<div id="hs-pmn-pro" role="tabpanel" aria-labelledby="hs-pmn-item-pro">
											{/* Header */}
											...
											<div className="p-3 max-h-[25rem] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
												...
												<div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
													...
													>
														<img className="dark:hidden w-28 rounded-lg shadow" alt="Main Page" />
														<img
															className="hidden dark:block w-28 rounded-lg shadow"
															// src="../../assets/img/demo-previews-dark/img1.jpg"
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Dashboard</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Shop</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Chat</p>
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Inbox</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Payment</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Calendars</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Workspace</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Analytics</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Project</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">SaaS</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Files</p>
													</a>
													{/* End Link */}
												</div>
												{/* End Grid */}
												...
												<div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Agency</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Personal</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">Admin</p>
													</a>
													{/* End Link */}
													{/* Link */}
													<a
													...
													>
														...
														<img
															...
															alt="Main Page"
														/>
														<p className="text-sm text-gray-800 dark:text-neutral-400">AI Prompt</p>
													</a>
													{/* End Link */}
												</div>
												{/* End Grid */}
						...
						<div className="xl:col-span-2 flex justify-end items-center gap-x-2">
							<div className="flex items-center">
								<div className="lg:hidden">
									...
									<button
										type="button"
										className="inline-flex shrink-0 justify-center items-center gap-x-2 size-[38px] rounded-full text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
										data-hs-overlay="#hs-pro-dnsm"
										aria-expanded="false"
									>
										<svg
									...
									<div className="hs-tooltip [--placement:bottom] inline-block">
										...
										<span
											...
											style={{
												...
												margin: 0,
												transform: 'translate3d(127.333px, 53px, 0px)'
											}}
									...
									<div className="hs-tooltip [--placement:bottom] inline-block">
										...
										<span
											...
											style={{
												...
												inset: '0px auto auto 0px',
												margin: 0,
												transform: 'translate3d(179.333px, 53px, 0px)'
											}}
											data-popper-placement="bottom"
										>
											Notifications
											...
											<div className="hs-tooltip relative inline-block mb-3">
												...
												<span
													...
													style={{
														...
														margin: 0,
														transform: 'translate3d(-430px, 5px, 0px)'
													}}
								...
								<div className="hs-tooltip [--placement:bottom] inline-block">
									...
									<span
										...
										style={{
											...
											inset: '0px auto auto 0px',
											margin: 0,
											transform: 'translate3d(232px, 53px, 0px)'
										}}
										data-popper-placement="bottom"
									>
										Activity
								...
								>
									...
									<div className="p-4 border-b border-gray-200 dark:border-neutral-700">
										...
										<div className="flex items-center gap-x-2">
											<div className="relative w-full">
												...
												<div className="absolute inset-y-0 end-0 flex items-center z-20 pe-[5px] text-gray-400">
													{/* Select */}
													<div className="relative inline-block">SELECT</div>
													{/* End Select */}
												</div>
											</div>
											<button
										...
										<div className="flex mt-2">
											<input
												type="checkbox"
												className="shrink-0 size-3.5 border-gray-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
												id="hs-pro-dnshdch"
												defaultChecked
											/>
											<label
									...
									>
										...
										<button
											type="button"
											className="hs-collapse-toggle hs-collapse-open:hidden w-full text-start flex items-center gap-x-3 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
							...
							<div className="hidden lg:block ms-2">
								...
								<div className="hs-dropdown  relative  [--auto-close:inside] inline-flex">
									<button
										...
										type="button"
										className="hs-dropdown-toggle  group relative flex justify-center items-center size-8 text-xs rounded-lg text-gray-800 hover:bg-gray-100 focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none"
										aria-haspopup="menu"
										aria-expanded="false"
										aria-label="Dropdown"
									>
									...
									>
										...
										{/* End Tab */}
										{/* Tab Content */}
										<div id="hs-pms-pro" role="tabpanel" aria-labelledby="hs-pms-item-pro">
											{/* Header */}
											<div className="p-3 flex flex-wrap justify-between items-center gap-3">
												<span className="block font-semibold text-sm text-gray-800 dark:text-neutral-200">
													Templates (12)
						...
						<div className="mt-1.5 h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
							...
							>
								<ul className="flex flex-col gap-y-1">
									...
									{/* End Link */}
									{/* Link */}
									<li className="hs-accordion px-2 lg:px-5 active " id="users-accordion">
										<button
											type="button"
										...
										>
											...
											>
												<li>
													<a
														className="flex gap-x-4 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700 bg-gray-100 dark:bg-neutral-700 "
										...
										>
											...
											>
												...
												<li>
													<a
														className="flex gap-x-4 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700  "
														href="../../pro/dashboard/user-profile-teams-list.html"
													>
														Teams: Listing
													</a>
												</li>
												...
												<li>
													<a
														className="flex gap-x-4 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700  "
														href="../../pro/dashboard/user-profile-files-list.html"
													>
														Files: Listing
													</a>
												</li>
												...
												<li>
													<a
														className="flex gap-x-4 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700  "
														href="../../pro/dashboard/user-profile-connections-list.html"
													>
														Connections: Listing
													</a>
												</li>
									...
									<li className="px-2 lg:px-5">
										...
										>
											...
											Inbox{' '}
											<span className="py-0.5 px-2 inline-flex items-center gap-x-1.5 text-xs font-medium bg-blue-100 text-blue-800 rounded-full dark:bg-blue-500/10 dark:text-blue-500">
												New
											</span>
										</a>
									</li>
						...
						<footer className="hidden lg:block border-t border-gray-200 dark:border-neutral-700">
							...
							<div className="px-7 ">
								<div className="hs-dropdown [--auto-close:inside] relative flex">
									...
									{/* Dropdown */}
									<div
										className="hs-dropdown-menu hs-dropdown-open:opacity-100 w-56 transition-[opacity,margin] duration opacity-0 z-20 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-900 hidden"
										role="menu"
										aria-orientation="vertical"
